...
function renderResults(parent: HTMLElement, showResults: boolean, results: Result[]) {
        ...
        results: [
          {
            title: 'Problem Set 5',
            subtitle: 'Problem 3',
            excerpt: 'the following keys into a <span class="highlight">binary search tree</span>, showing the',
          },
          {
            title: 'Problem Set 2',
            subtitle: 'Problem 6',
            excerpt: 'form the keys of a <span class="highlight">binary search tree</span>, what would the',
          },
          {
            title: 'Lecture 3',
            subtitle: 'Coursepack page 59',
            excerpt: 'in a <span class="highlight">binary search tree</span> the keys are kept in order such that',
          },
        ],
      })
    }
